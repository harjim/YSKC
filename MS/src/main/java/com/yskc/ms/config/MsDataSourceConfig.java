 ...
 */
@Configuration
@MapperScan(basePackages = {"com.yskc.ms.dao.ms"}, sqlSessionFactoryRef = "msSqlSessionFactory")
public class MsDataSourceConfig
{
    ...
    public MybatisSqlSessionFactoryBean plusSqlSessionFactory(@Qualifier("msDataSource") DataSource dataSource,
        ...
        sqlSessionFactoryBean.setMapperLocations(
                new PathMatchingResourcePatternResolver().getResources(MsDataSourceConfig.MAPPER_LOCATION));
