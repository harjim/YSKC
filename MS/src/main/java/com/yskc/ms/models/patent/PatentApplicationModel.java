 ...
 **/
public class PatentApplicationModel implements Serializable {
    private Integer id;
    //需求编号,格式yymmdd0001
    ...
    //技术人员(工程师)
    private HashSet<String> techName = new HashSet<>();
    //业务员id
    ...
    public HashSet<String> getOwnerName() {
        return ownerName;
    }

    public void setOwnerName(HashSet<String> ownerName) {
        this.ownerName = ownerName;
    }

    public HashSet<String> getTechName() {
        return techName;
    }

    public void setTechName(HashSet<String> techName) {
