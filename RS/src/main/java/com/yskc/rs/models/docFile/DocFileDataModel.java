...
public class DocFileDataModel implements Serializable {
    ...
    private Map<String, EmployeeAutographModel> employeeMap;
    ...
    public Map<String, EmployeeAutographModel> getEmployeeMap() {
        return employeeMap;
    }

    public void setEmployeeMap(Map<String, EmployeeAutographModel> employeeMap) {
