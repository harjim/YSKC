...
public class EmployeeEntity implements Serializable {
    ...
    public static EmployeeEntity build(UserInfo info, Date now, Integer deptId, InitMemberExcel excel) {
    ...
    public static EmployeeEntity build(UserInfo info, Date now, Integer deptId, String ename, String enumber, String deptName) {
        EmployeeEntity employeeEntity = new EmployeeEntity();
    ...
    void setEntityBase(UserInfo info, Date now, Integer deptId) {
        this.deptId = deptId;
        this.createTime = now;
