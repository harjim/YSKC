...
public class EnergyEntity implements Serializable {
    ...
    public static EnergyEntity build(Integer id, BigDecimal remainAmount) {
        EnergyEntity e = new EnergyEntity();
        e.id = id;
        e.amount = e.remainAmount = remainAmount;
        return e;
    }
    public static EnergyEntity build(Integer id, BigDecimal amount, BigDecimal remainAmount) {
        EnergyEntity e = new EnergyEntity();
        e.id = id;
        e.amount = amount;
    ...
    public void addRemainAmount(BigDecimal rdAmount) {
        this.remainAmount = this.remainAmount.add(rdAmount);
    }
}
