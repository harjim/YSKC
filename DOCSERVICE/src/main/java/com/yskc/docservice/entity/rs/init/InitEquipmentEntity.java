...
public class InitEquipmentEntity implements Serializable {
    ...
    public static InitEquipmentEntity build(RsUserInfo info, String ecode, String effect, Integer projectId, Date now,Date entryDate,Integer year) {
    ...
    public static InitEquipmentEntity buildUpdate(RsUserInfo info, String effect, Date now, Date entryDate) {
