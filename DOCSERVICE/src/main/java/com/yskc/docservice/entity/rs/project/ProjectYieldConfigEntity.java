...
public class ProjectYieldConfigEntity {
    ...
    private BigDecimal testHour = BigDecimal.ZERO;  //检验工时
    ...
    public static ProjectYieldConfigEntity build(Date now, Integer userId, Integer msUserId, Integer projectId,
                                                 ...
                                                 Date startTime, Date endTime, Integer source) {
    ...
    public void buildCreate(Date now, RsUserInfo userInfo) {
        createTime = now;
    ...
    public void buildUpdate(Date now, RsUserInfo userInfo) {
        lastUpdateTime = now;
