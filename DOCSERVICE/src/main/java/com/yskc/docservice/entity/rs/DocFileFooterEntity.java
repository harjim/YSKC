...
public class DocFileFooterEntity implements Serializable {
    ...
    public DocFileFooterEntity(Integer projectId, Integer companyId, String auditEnumber,
                               String toCompileEnumber, String approvalEnumber, Integer msUserId,
                               Integer userId, Date date, Integer year) {
        this.projectId = projectId;
        this.companyId = companyId;
        this.auditEnumber = auditEnumber;
        this.toCompileEnumber = toCompileEnumber;
