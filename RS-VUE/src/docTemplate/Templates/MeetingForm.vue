 ...
 * @LastEditTime: 2022-09-17 09:09:05
 * @LastEditors: hm
 * @Description: 会议纪要 —— V1.0
 * @FilePath: \RS-VUE\src\docTemplate\Templates\MeetingForm.vue
-->
<template>
  <a-card id="container">
...
export default {
  ...
  methods: {
    ...
    onDateChange (date, dateString) {
      ...
      if (this.$refs.auditFooter && this.$refs.auditFooter.handleGetDocFooter) {
        this.$refs.auditFooter.handleGetDocFooter(this.projectId, this.fileDate.year())
      }
