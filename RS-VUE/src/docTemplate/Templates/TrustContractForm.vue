 ...
 * @LastEditors: hm
 * @LastEditTime: 2022-09-14 11:50:49
 * @Description: 委外合同 —— 默认模板
 * @FilePath: \RS-VUE\src\docTemplate\Templates\TrustContractForm.vue
-->
...
export default {
  name: 'TrustContractForm',
  components: {
    upload
  },

  created () {
    this.content = getTemplateContent('TrustContractForm')
    this.BPContent = getTemplateContent('TrustContractForm')
  },
