  ...
  >
    ...
    >
      <a-anchor :affix="false">
        <a-anchor-link title="6.1经营风险对策">
          <a-anchor-link title="6.1.1经营风险因素" />
          <a-anchor-link title="6.1.2经营风险对策" />
        </a-anchor-link>
        <a-anchor-link title="6.2管理风险对策">
          <a-anchor-link title="6.2.1管理风险因素" />
          <a-anchor-link title="6.2.2管理风险对策" />
        </a-anchor-link>
        <a-anchor-link title="6.3财务风险对策">
          <a-anchor-link title="6.3.1财务风险因素" />
          <a-anchor-link title="6.3.2财务风险对策" />
        </a-anchor-link>
      </a-anchor>
    </a-layout-sider>
    <a-layout>
            ...
            >
              ...
              >
                <a-card
                  title="6.1经营风险对策"
                  :bordered="false"
                  :id="`risk_link_${projectId}_1`"
                >
                  <a-form-item>
                    <template slot="label">
                      <span>
                        6.1.1经营风险因素
                        <a :id="`risk_link_${projectId}_2`" />
                      </span>
                    </template>
                    <a-textarea
                      rows="4"
                      v-model="dataMap['6.1.1'].textItem.content"
                      placeholder="经营风险因素"
                    />
                  </a-form-item>
                  <a-form-item>
                    <template slot="label">
                      <span>
                        6.1.2经营风险对策
                        <a :id="`risk_link_${projectId}_3`"></a>
                      </span>
                    </template>
                    <a-textarea
                      rows="4"
                      v-model="dataMap['6.1.2'].textItem.content"
                      placeholder="经营风险对策"
                    />
                  </a-form-item>
                </a-card>
                <a-card
                  title="6.2管理风险对策"
                  :bordered="false"
                  :id="`risk_link_${projectId}_4`"
                >
                  <a-form-item>
                    <template slot="label">
                      <span>
                        6.2.1管理风险因素
                        <a :id="`risk_link_${projectId}_5`" />
                      </span>
                    </template>
                    <a-textarea
                      rows="4"
                      v-model="dataMap['6.2.1'].textItem.content"
                      placeholder="管理风险因素"
                    />
                  </a-form-item>
                  <a-form-item>
                    <template slot="label">
                      <span>
                        6.2.2管理风险对策
                        <a :id="`risk_link_${projectId}_6`"></a>
                      </span>
                    </template>
                    <a-textarea
                      rows="4"
                      v-model="dataMap['6.2.2'].textItem.content"
                      placeholder="管理风险对策"
                    />
                  </a-form-item>
                </a-card>
                <a-card
                  title="6.3财务风险对策"
                  :bordered="false"
                  :id="`risk_link_${projectId}_7`"
                >
                  <a-form-item>
                    <template slot="label">
                      <span>
                        6.3.1财务风险因素
                        <a :id="`risk_link_${projectId}_8`" />
                      </span>
                    </template>
                    <a-textarea
                      rows="4"
                      v-model="dataMap['6.3.1'].textItem.content"
                      placeholder="管理风险因素"
                    />
                  </a-form-item>
                  <a-form-item>
                    <template slot="label">
                      <span>
                        6.3.2财务风险对策
                        <a :id="`risk_link_${projectId}_9`"></a>
                      </span>
                    </template>
                    <a-textarea
                      rows="4"
                      v-model="dataMap['6.3.2'].textItem.content"
                      placeholder="财务风险对策"
                    />
                  </a-form-item>
                </a-card>
...
export default {
  ...
  data () {
    return {
      ...
      imgMap: {},
      defaultMap: {
        '6.1': { textItem: { type: 1, content: null } },
        '6.1.1': { textItem: { type: 1, content: null } },
        '6.1.2': { textItem: { type: 1, content: null } },
        '6.2': { textItem: { type: 1, content: null } },
        '6.2.1': { textItem: { type: 1, content: null } },
        '6.2.2': { textItem: { type: 1, content: null } },
        '6.3': { textItem: { type: 1, content: null } },
        '6.3.1': { textItem: { type: 1, content: null } },
        '6.3.2': { textItem: { type: 1, content: null } }
      },
      dataMap: {
        '6.1': { textItem: { type: 1, content: null } },
        '6.1.1': { textItem: { type: 1, content: null } },
