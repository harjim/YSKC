 ...
 * @LastEditTime: 2021-05-13 17:10:56
 * @LastEditors: ldx
 * @Description: 研发支出辅助帐及汇总表
 * @FilePath: \RS-VUE\src\views\project\modules\ProjectSummary.vue
-->
<template>
...
<script>
import { getProjectSummary } from '@/api/ForFutureReferenceData'
...
export default {
  ...
  methods: {
    ...
    handleGetProjectSummary () {
      ...
      const params = { year: this.currentYear, projectId: this.projectId }
