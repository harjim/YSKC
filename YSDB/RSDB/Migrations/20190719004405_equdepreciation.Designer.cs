...
namespace RSDB.Migrations
{
    ...
    [Migration("20190719004405_equdepreciation")]
    partial class equdepreciation
    {
            ...
            modelBuilder.Entity("RSDB.Models.equipment", b =>
                {
                    ...
                    b.Property<DateTime>("depreciationDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 19, 0, 0, 0, 0, DateTimeKind.Local));
            ...
            modelBuilder.Entity("RSDB.Models.p_attendance", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 19, 8, 44, 5, 420, DateTimeKind.Local).AddTicks(3685));
            ...
            modelBuilder.Entity("RSDB.Models.p_design", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 19, 8, 44, 5, 420, DateTimeKind.Local).AddTicks(5605));
            ...
            modelBuilder.Entity("RSDB.Models.p_energy", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 19, 8, 44, 5, 420, DateTimeKind.Local).AddTicks(1701));
            ...
            modelBuilder.Entity("RSDB.Models.p_inspection", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 19, 8, 44, 5, 420, DateTimeKind.Local).AddTicks(7481));
            ...
            modelBuilder.Entity("RSDB.Models.p_material", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 19, 8, 44, 5, 420, DateTimeKind.Local).AddTicks(9189));
