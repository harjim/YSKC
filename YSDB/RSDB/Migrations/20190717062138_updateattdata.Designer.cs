...
namespace RSDB.Migrations
{
    ...
    [Migration("20190717062138_updateattdata")]
    partial class updateattdata
    {
            ...
            modelBuilder.Entity("RSDB.Models.equipment", b =>
                {
                    ...
                    b.Property<DateTime>("depreciationDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 17, 0, 0, 0, 0, DateTimeKind.Local));
            ...
            modelBuilder.Entity("RSDB.Models.p_attendance", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 17, 14, 21, 37, 887, DateTimeKind.Local).AddTicks(8952));
            ...
            modelBuilder.Entity("RSDB.Models.p_design", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 17, 14, 21, 37, 888, DateTimeKind.Local).AddTicks(922));
            ...
            modelBuilder.Entity("RSDB.Models.p_energy", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 17, 14, 21, 37, 887, DateTimeKind.Local).AddTicks(7019));
            ...
            modelBuilder.Entity("RSDB.Models.p_inspection", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 17, 14, 21, 37, 888, DateTimeKind.Local).AddTicks(2790));
            ...
            modelBuilder.Entity("RSDB.Models.p_material", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 17, 14, 21, 37, 888, DateTimeKind.Local).AddTicks(4627));
