...
namespace RSDB.Migrations
{
    ...
    [Migration("20190720020326_companycodelength")]
    partial class companycodelength
    {
            ...
            modelBuilder.Entity("RSDB.Models.equipment", b =>
                {
                    ...
                    b.Property<DateTime>("depreciationDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 20, 0, 0, 0, 0, DateTimeKind.Local));
            ...
            modelBuilder.Entity("RSDB.Models.p_attendance", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 20, 10, 3, 26, 444, DateTimeKind.Local).AddTicks(1474));
            ...
            modelBuilder.Entity("RSDB.Models.p_design", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 20, 10, 3, 26, 444, DateTimeKind.Local).AddTicks(3781));
            ...
            modelBuilder.Entity("RSDB.Models.p_energy", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 20, 10, 3, 26, 443, DateTimeKind.Local).AddTicks(9497));
            ...
            modelBuilder.Entity("RSDB.Models.p_inspection", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 20, 10, 3, 26, 444, DateTimeKind.Local).AddTicks(7641));
            ...
            modelBuilder.Entity("RSDB.Models.p_material", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 20, 10, 3, 26, 445, DateTimeKind.Local).AddTicks(759));
