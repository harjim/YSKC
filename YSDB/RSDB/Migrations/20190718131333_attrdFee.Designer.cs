...
namespace RSDB.Migrations
{
    ...
    [Migration("20190718131333_attrdFee")]
    partial class attrdFee
    {
            ...
            modelBuilder.Entity("RSDB.Models.equipment", b =>
                {
                    ...
                    b.Property<DateTime>("depreciationDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 18, 0, 0, 0, 0, DateTimeKind.Local));
            ...
            modelBuilder.Entity("RSDB.Models.p_attendance", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 18, 21, 13, 33, 203, DateTimeKind.Local).AddTicks(2964));
            ...
            modelBuilder.Entity("RSDB.Models.p_design", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 18, 21, 13, 33, 203, DateTimeKind.Local).AddTicks(4849));
            ...
            modelBuilder.Entity("RSDB.Models.p_energy", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 18, 21, 13, 33, 203, DateTimeKind.Local).AddTicks(855));
            ...
            modelBuilder.Entity("RSDB.Models.p_inspection", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 18, 21, 13, 33, 203, DateTimeKind.Local).AddTicks(6673));
            ...
            modelBuilder.Entity("RSDB.Models.p_material", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 18, 21, 13, 33, 203, DateTimeKind.Local).AddTicks(8393));
