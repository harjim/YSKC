...
namespace RSDB.Migrations
{
    ...
    [Migration("20190718002942_accountcompany")]
            ...
            modelBuilder.Entity("RSDB.Models.p_attendance", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 18, 8, 29, 42, 103, DateTimeKind.Local).AddTicks(8304));
            ...
            modelBuilder.Entity("RSDB.Models.p_design", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 18, 8, 29, 42, 104, DateTimeKind.Local).AddTicks(3474));
            ...
            modelBuilder.Entity("RSDB.Models.p_energy", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 18, 8, 29, 42, 103, DateTimeKind.Local).AddTicks(2910));
            ...
            modelBuilder.Entity("RSDB.Models.p_inspection", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 18, 8, 29, 42, 104, DateTimeKind.Local).AddTicks(8622));
            ...
            modelBuilder.Entity("RSDB.Models.p_material", b =>
                {
                    ...
                    b.Property<DateTime>("lastUpdateTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 7, 18, 8, 29, 42, 105, DateTimeKind.Local).AddTicks(3541));
