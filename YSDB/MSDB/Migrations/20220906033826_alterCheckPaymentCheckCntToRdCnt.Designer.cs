...
namespace MSDB.Migrations
{
    ...
    [Migration("20220906033826_alterCheckPaymentCheckCntToRdCnt")]
    partial class alterCheckPaymentCheckCntToRdCnt
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MSDB.Models.checkPayment", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MSDB.Models.checkPayment_rd", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd();

                    b.Property<int>("checkPaymentId");
                    ...
                    b.ToTable("checkPayment_rd");
                });

            modelBuilder.Entity("MSDB.Models.contract", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("expressAddress")
                        .HasMaxLength(100);
                    ...
                    b.Property<int>("partnerCnt");

                    b.Property<int>("projectCnt");
            ...
            modelBuilder.Entity("MSDB.Models.contract_member", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("contract_member");
                });

            modelBuilder.Entity("MSDB.Models.contract_project", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("signCnt");

                    b.HasKey("id");

                    b.HasIndex("customerId", "productId", "signCnt")
                        .IsUnique();

                    b.ToTable("contract_project");
                });
            ...
            modelBuilder.Entity("MSDB.Models.finaDaily", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MSDB.Models.patent_supplier", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd();
